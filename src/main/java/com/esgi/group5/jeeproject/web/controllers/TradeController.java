...
import com.esgi.group5.jeeproject.web.dtos.trades.EditTradeDTO;
import com.esgi.group5.jeeproject.web.dtos.trades.parsers.TradeParser;
...
public class TradeController {
    ...
    public ResponseEntity<?> get(){
        Collection<Trade> trades = readTradeService.get();
    ...
    public ResponseEntity<?> get(@PathVariable("tradeId") Long tradeId){
        Trade trade = readTradeService.get(tradeId);
        return trade != null ?
            ResponseEntity
                .status(HttpStatus.OK)
                .body(trade) :
